...
export const createService = async (req: AuthRequest, res: Response) => {
  ...
  .json(successResponse('Service created successfully', result, 201));
};
...
export const getServiceById = async (req: AuthRequest, res: Response) => {
  ...
  return res.status(200)
  .json(successResponse('Service retrieved successfully', result));
};
...
export const getUserServices = async (req: AuthRequest, res: Response) => {
  ...
  return res.status(200)
  .json(successResponse('User services retrieved successfully', result));
};